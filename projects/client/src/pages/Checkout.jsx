...
export default function Checkout() {
  ...
  const getRajaOngkirCity = async () => {
    ...
    console.log("env", process.env.REACT_APP_RAJA_ONGKIR_API_KEY);
  ...
  console.log("city raja nih", cityRaja);
    ...
    const fetchOngkir = async () => {
      try {
        if (cityId && originId) {
          ...
          console.log("ongkir2", response.data.rajaongkir.results[0].costs);
  ...
  const totalPriceWithShipping =
    totalPrice +
    (selectedShippingOption ? parseInt(selectedShippingOption) : 0);
                  ...
                  <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                    <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                      <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900">
                          {numToIDRCurrency(value.Product.price * value.qty)}
                        </p>
                      </div>
                ...
                >
                  ...
                  >
                    ...
                    {ongkir.map((value) => (
                      ...
                      >
                        {value.service} |{" "}
                        {numToIDRCurrency(value.cost[0].value)} est.{" "}
                        {value.cost[0].etd} days
                      </option>
                    ))}
                  </select>
                </dd>
