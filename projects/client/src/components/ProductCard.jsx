  ...
  return (
    <div className="mb-8 grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8">
      {products.map((product) => (
        <div
          key={product.id}
          className="shadow-md rounded-md border px-4"
        >
          <div>
          ...
          <div className="my-6">
            <button
              className="relative w-full flex items-center justify-center rounded-md border border-transparent bg-gray-100 py-2 px-8 text-sm font-medium text-gray-900 hover:bg-gray-200 disabled-button"
              disabled={!user.id}
            >
              Add to cart
