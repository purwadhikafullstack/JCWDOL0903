...
module.exports = {
    getProvince: async (req, res) => {
        try{
            const response = await axios.get("https://api.wilayah-nusantara.id/provinsi",{params:{limit:100}})
    ...
    getCity: async (req, res) => {
        try {
          ...
          const response = await axios.get("https://api.wilayah-nusantara.id/kabupaten", {
            params: {
              provinsiCode
            }
          });
